# 👋 Hi there! I'm Dmitrii — Data Analyst & ML Enthusiast
...
- 🛠️ Руководил миграцией данных между БД, координируя требования для front- и back-end команд.
- 🤖 Разрабатывал ботов Slack\Telegram для ad-hoc аналитики и автоматизированной отчётности (Airflow, Sheets).
...
<details>
  ...
  [**Скачать файл**](https://drive.google.com/file/d/1G6_03nD0wuEKPlbdKVPTdMuyYNGEqZl1)
</details>
